...
{ 
    if (isset($_SERVER['HTTP_VIA']) && stristr($_SERVER['HTTP_VIA'], "wap")) {
        ...
        return true;
    }elseif (isset($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'] , 'wxwork') !== false ) {
		return true;
	}else {
		return false;
	}
...
function is_wxwork()
{
	if (isset($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'] , 'wxwork') !== false ) {
		return true;
	} else {
		return false;
	}
...
{
	if (isset($_SERVER['HTTP_USER_AGENT']) && strpos($_SERVER['HTTP_USER_AGENT'] , 'DingTalk') !== false ) {
		return true;
	} else {
		return false;
	}
